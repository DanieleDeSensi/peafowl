...
#define DPI_IPv4_FRAGMENTATION_DEFAULT_TOTAL_MEMORY_LIMIT                    \
...
#define DPI_IPv6_FRAGMENTATION_DEFAULT_TOTAL_MEMORY_LIMIT                    \
  10240000 /* 10M. If each host fills its memory limit, we can support up to \
              1000 hosts. */
...
#define DPI_MULTICORE_L3_L4_FARM_INPUT_BUFFER_SIZE \
  DPI_MULTICORE_DEFAULT_BUFFER_SIZE
#endif

#ifndef DPI_MULTICORE_L3_L4_FARM_OUTPUT_BUFFER_SIZE
#define DPI_MULTICORE_L3_L4_FARM_OUTPUT_BUFFER_SIZE \
  DPI_MULTICORE_DEFAULT_BUFFER_SIZE
#endif

#ifndef DPI_MULTICORE_L7_FARM_INPUT_BUFFER_SIZE
#define DPI_MULTICORE_L7_FARM_INPUT_BUFFER_SIZE \
  DPI_MULTICORE_DEFAULT_BUFFER_SIZE
#endif

#ifndef DPI_MULTICORE_L7_FARM_OUTPUT_BUFFER_SIZE
#define DPI_MULTICORE_L7_FARM_OUTPUT_BUFFER_SIZE \
  DPI_MULTICORE_DEFAULT_BUFFER_SIZE
#endif

#ifndef DPI_MULTICORE_PIPELINE_INPUT_BUFFER_SIZE
#define DPI_MULTICORE_PIPELINE_INPUT_BUFFER_SIZE \
  DPI_MULTICORE_DEFAULT_BUFFER_SIZE
#endif

#ifndef DPI_MULTICORE_PIPELINE_OUTPUT_BUFFER_SIZE
#define DPI_MULTICORE_PIPELINE_OUTPUT_BUFFER_SIZE \
  DPI_MULTICORE_DEFAULT_BUFFER_SIZE
#endif
