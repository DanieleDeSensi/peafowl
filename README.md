...
For other API calls (e.g. to extract specific L7 fields from the packets), please refer to the documentation in ["peafowl.h"](include/peafowl/peafowl.h) header.
